    ...
    echo '<tbody>';
     while($row = $result->fetch_assoc()){
      echo '<tr>';
       ...
       echo '<td>';
        echo '<form action="editpolicy.php" class="d-inline" method="POST">';
...
<?php
 ...
 $sql = "DELETE FROM policies_tb WHERE pid = {$_REQUEST['id']}";
...
?>
  ...
  <div class="float-right"><a href="addpolicy.php" class="btn btn-info"><i class="fas fa-plus fa-2x"></i></a></div>
 </div>
